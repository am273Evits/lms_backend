...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('business_leads', '0027_alter_service_associate_id_alter_service_lead_status'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='service',
            name='lead_status',
            field=models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, to='dropdown.lead_status'),
        ),
    ]
